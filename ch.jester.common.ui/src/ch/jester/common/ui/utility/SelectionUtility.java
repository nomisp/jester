...
public class SelectionUtility {
	...
	/**
	 * Falls die gesetzte ISelection eine IStructuredSelection ist, wird das
	 * erste Element zurückgegeben. Sonst null
	 * 
	...
	/**
	 * @return IStructuredSelection oder null, wenn es keine StructuredSelection
	 *         ist
	 */
	...
	/**
	 * Castet das erste seleketierte Element in die übergebene Klasse und gibt
	 * dieses zurück
	 * 
	 * @param <T>
	 * @param clz
	 * @return Objekt von <code>clz</code> oder null, wenn es nicht gecastet
	 *         werden kann
	 */
